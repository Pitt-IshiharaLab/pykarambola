...
\texttt{minkowski\_tensors\_from\_label\_image(label\_image)} accepts a three-dimensional integer NumPy array in which each nonzero value identifies an object.
