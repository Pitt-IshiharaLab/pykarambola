...
Approaches based on spherical harmonics~\cite{ruan2019evaluation} or learned point-cloud representations~\cite{viana2023integrated} capture richer structural information but are restricted to genus-zero surfaces or require large training datasets and do not generalise to objects with complex 3D topology.
